...
const PollutantPanel = ({ pollutants, subIndices, dominantPollutant }) => {
    ...
    const list = [
        ...
        { id: 'nh3',  label: 'NH3',   value: pollutants.nh3,  unit: 'µg/m³', aqi: subIndices?.nh3 },
    ];
    ...
    return (
        <div className="glass-card p-8 flex flex-col h-full rounded-[2rem] shadow-xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5 flex-grow">
                {list.map((item) => {
                    ...
                    return (
                        <div 
                            key={item.id} 
                            className={`p-4 rounded-[1.5rem] border transition-all duration-500 flex flex-col justify-between relative overflow-hidden group hover:-translate-y-1 ${
                        ...
                        >
                            ...
                            <div className="space-y-1 relative z-10">
                                <div className="text-2xl font-black text-[var(--text-primary)] leading-none tracking-tighter">
                            ...
                            <div className="mt-4 pt-3 border-t border-[var(--glass-border)] flex items-center justify-between relative z-10">
